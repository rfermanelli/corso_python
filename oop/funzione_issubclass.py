...
# restituisce True se il primo parametro è una sottoclasse del secondo; False altrimenti.
...
print(issubclass(Stella, CorpoCeleste))
print(issubclass(Stella, Stella))
print(issubclass(Pianeta, Stella))